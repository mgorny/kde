...
# ${WORKDIR}/${P}_build (in EAPI-8: ${CMAKE_USE_DIR}_build).
...
# By default it uses ${S} (in EAPI-8: current working directory).
...
# @DEFAULT_UNSET
# @DESCRIPTION:
# After running cmake_src_prepare, sets ${S} (in EAPI-8: ${CMAKE_USE_DIR}) to
...
cmake_src_prepare() {
	...
	# Make ${S} (in EAPI-8: ${CMAKE_USE_DIR}) read-only in order to detect
